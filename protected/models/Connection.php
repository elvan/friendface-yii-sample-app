...
class Connection extends CActiveRecord {
  ...
  public function rules() {
    ...
    return array(
      ...
      array('follower_id, followed_id, create_time, update_time', 'numerical', 'integerOnly'=>true),
      // The following rule is used by search().
      // Please remove those attributes that should not be searched.
      array('id, follower_id, followed_id, create_time, update_time', 'safe', 'on'=>'search'),
    );
  }
  ...
  public function relations() {
    ...
    return array(
      'follower' => array(self::BELONGS_TO, 'Profile', 'follower_id'),
      'followed' => array(self::BELONGS_TO, 'Profile', 'followed_id'),
    );
  }
